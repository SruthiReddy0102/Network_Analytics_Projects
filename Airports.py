...
data = pd.read_csv("C:/Data Science/Assignments/Module-Network Analytics/Network Analytics Datasets/connecting_routes.csv")
...
G = pd.read_csv("C:/Data Science/Assignments/Module-Network Analytics/Network Analytics Datasets/connecting_routes.csv")
