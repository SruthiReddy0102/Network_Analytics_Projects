...
##### Airlines Network using Edge List #####

airports <- read.csv("C:/Data Science/Assignments/Module-Network Analytics/Network Analytics Datasets/flight_hault.csv", header = FALSE)
...
airline_routes <- read.csv("C:/Data Science/Assignments/Module-Network Analytics/Network Analytics Datasets/connecting_routes.csv", header=FALSE)
colnames(airline_routes) <- c("Airline", "Airline ID", "main Airport","main Airport ID","Destination Airport","Destination Airport ID","Stops","Equipment")
head(airline_routes)
